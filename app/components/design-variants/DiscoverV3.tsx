...
function Logo() {
  return (
    ...
    >
      <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 to-violet-600 text-base shadow-lg shadow-indigo-500/20">
        🍽️
      </span>
      Family Recipe
    </Link>
...
export default function DiscoverV3() {
  return (
    <div className="flex min-h-screen flex-col bg-zinc-950 text-white">
      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-zinc-950/70 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 sm:px-8 lg:px-12">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/login"
              className="hidden rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-zinc-200 transition-colors hover:bg-white/10 sm:inline-flex"
            >
              Log in
            </Link>
            <Link
              href="/signup"
              className="rounded-full bg-white px-4 py-2 text-sm font-semibold text-zinc-950 transition-colors hover:bg-zinc-200"
            >
              Sign up
            </Link>
          </div>
      ...
      <main className="relative flex-1">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-16 sm:px-8 lg:px-12">
          <div className="v3-fade mb-16 flex flex-col items-start justify-between gap-8 md:flex-row md:items-end">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-lg leading-relaxed text-zinc-400">
                Browse public recipes shared by the community — curated for the
                modern kitchen.
              </p>
            </div>
            ...
            >
              <label htmlFor="v3-q" className="sr-only">
                Search recipes
              </label>
              <input
                id="v3-q"
                ...
                className="h-12 flex-1 rounded-full border border-white/10 bg-white/5 px-5 text-sm text-white placeholder:text-zinc-500 backdrop-blur-md transition-colors focus-visible:outline-none focus-visible:border-indigo-500/50 focus-visible:bg-white/10"
              />
              <button
                type="submit"
                className="h-12 rounded-full bg-white px-6 text-sm font-semibold text-zinc-950 transition-all hover:bg-zinc-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950"
              >
                Search
              </button>
            </form>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {recipes.map((recipe, index) => (
              <div
                key={recipe.id}
                className="v3-fade group relative flex flex-col overflow-hidden rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl transition-all duration-500 hover:-translate-y-1 hover:border-white/20 hover:bg-white/10"
              ...
              >
                <div className="relative aspect-[4/3] w-full overflow-hidden">
                  ...
                  <div className="absolute bottom-3 left-3 flex items-center gap-2">
                    <span className="rounded-full bg-white/10 px-2.5 py-1 text-xs font-medium text-white backdrop-blur-md">
                      {recipe.ingredients.length} ingredients
                    </span>
                    <span className="rounded-full bg-indigo-500/80 px-2.5 py-1 text-xs font-medium text-white backdrop-blur-md">
      ...
      <footer className="border-t border-white/10 bg-zinc-950 py-12">
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          <div className="flex flex-col items-start justify-between gap-8 md:flex-row">
            ...
            <nav className="flex flex-wrap gap-6 text-sm font-medium text-zinc-400">
