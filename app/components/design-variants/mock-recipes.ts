// Shared mock recipe data for design-variant components only.
// This is NOT the real data layer — variants must never import from app/lib or prisma.
// Keeping it here lets each variant focus on design instead of repeating 200 lines of data.
...
export interface MockRecipe {
  ...
  authorId: string;
  authorName: string;
  /** A short cuisine/category label, handy for editorial variants. */
  category: string;
  /** Rough total time in minutes, for variants that show timing. */
  minutes: number;
}
