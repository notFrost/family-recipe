...
// Hand-placed food/kitchen doodles for the WhatsApp-wallpaper-style background
// layer. Each entry sets position (% of the page box), icon size, and a slight
// rotation so the scatter reads as organic rather than a rigid grid. The set is
// roughly tiled top-to-bottom at moderate density.
const doodles: { Icon: LucideIcon; top: string; left: string; size: number; rotate: number }[] = [
  { Icon: ChefHat, top: "3%", left: "8%", size: 60, rotate: -12 },
  { Icon: Pizza, top: "6%", left: "44%", size: 52, rotate: 10 },
  { Icon: Coffee, top: "4%", left: "78%", size: 46, rotate: -6 },
  { Icon: Egg, top: "12%", left: "23%", size: 40, rotate: 14 },
  { Icon: Soup, top: "14%", left: "63%", size: 58, rotate: -8 },
  { Icon: Croissant, top: "11%", left: "90%", size: 48, rotate: 18 },
  { Icon: Carrot, top: "21%", left: "5%", size: 50, rotate: 20 },
  { Icon: Salad, top: "23%", left: "37%", size: 54, rotate: -14 },
  { Icon: Wine, top: "20%", left: "71%", size: 44, rotate: 8 },
  { Icon: Cookie, top: "29%", left: "16%", size: 46, rotate: -18 },
  { Icon: Fish, top: "31%", left: "52%", size: 56, rotate: 12 },
  { Icon: Wheat, top: "28%", left: "85%", size: 52, rotate: -10 },
  { Icon: UtensilsCrossed, top: "39%", left: "9%", size: 48, rotate: 16 },
  { Icon: CakeSlice, top: "41%", left: "45%", size: 50, rotate: -6 },
  { Icon: Cherry, top: "38%", left: "77%", size: 42, rotate: 22 },
  { Icon: IceCreamCone, top: "47%", left: "27%", size: 46, rotate: -16 },
  { Icon: Apple, top: "49%", left: "62%", size: 48, rotate: 10 },
  { Icon: Utensils, top: "46%", left: "92%", size: 44, rotate: -12 },
  { Icon: Soup, top: "56%", left: "6%", size: 54, rotate: 14 },
  { Icon: Coffee, top: "58%", left: "40%", size: 46, rotate: -8 },
  { Icon: Pizza, top: "55%", left: "72%", size: 52, rotate: 18 },
  { Icon: Croissant, top: "65%", left: "19%", size: 48, rotate: -20 },
  { Icon: Wheat, top: "67%", left: "54%", size: 50, rotate: 8 },
  { Icon: ChefHat, top: "63%", left: "86%", size: 56, rotate: -10 },
  { Icon: Carrot, top: "74%", left: "11%", size: 46, rotate: 16 },
  { Icon: Cherry, top: "76%", left: "47%", size: 42, rotate: -14 },
  { Icon: Fish, top: "72%", left: "79%", size: 52, rotate: 12 },
  { Icon: Egg, top: "83%", left: "24%", size: 40, rotate: -18 },
  { Icon: Salad, top: "85%", left: "60%", size: 54, rotate: 10 },
  { Icon: Cookie, top: "82%", left: "91%", size: 46, rotate: -6 },
  { Icon: CakeSlice, top: "92%", left: "8%", size: 50, rotate: 18 },
  { Icon: Wine, top: "94%", left: "42%", size: 44, rotate: -12 },
  { Icon: Apple, top: "91%", left: "74%", size: 48, rotate: 14 },
];
...
function buildPalette(theme: Theme, isDark: boolean) {
  ...
  return {
    ...
    // never competes with text. Cards sit on the solid `card` token, so card
    // copy stays crisp regardless of the doodles behind them.
    doodle: `${t.foreground}${isDark ? "0E" : "08"}`,
  };
}
...
function DoodleLayer({ palette }: { palette: Palette }) {
  return (
    <div
      aria-hidden="true"
